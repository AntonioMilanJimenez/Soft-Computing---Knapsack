...
weights = [5,12,3,2,47,15,18,7,6,4,13,11,16]
values = [2,4,4,1,8,6,2,6,3,10,2,8,5]
ant_solution = ant_colony_optimization(weights,values,max_weight,num_iterations=200)
...
solutionGreedy = greedySolution(p8['weights'],p8['profits'],p8['capacity'])
print("Solucion Greedy: " + str(solutionGreedy) + " con beneficio: " + str(calculateSolutionValue(p8['profits'],solutionGreedy)))

solutionLS = localSearch(solutionGreedy,p8['capacity'],p8['profits'],p8['weights'])
print("Solucion LS: " + str(solutionLS) + " con beneficio: " + str(calculateSolutionValue(p8['profits'],solutionLS)))

solutionGenetic = geneticAlgorithm(p8['capacity'],p8['weights'],p8['profits'],8,1000,memetico=False,nItersLS=0)
print("Solucion Genetico: " + str(solutionGenetic[0]) + " con beneficio: " + str(solutionGenetic[1]))

solutionMemetic = geneticAlgorithm(p8['capacity'],p8['weights'],p8['profits'],8,100,memetico=True,nItersLS=50)
print("Solucion Memetico: " + str(solutionMemetic[0]) + " con beneficio: " + str(solutionMemetic[1]))

ant_solution = ant_colony_optimization(p8['weights'],p8['profits'],p8['capacity'],num_iterations=200)
print("Solucion ACO: " + str(ant_solution) + " con beneficio: " + str(calculateSolutionValue(p8['profits'],ant_solution)))
